...
| [**`aas-submodel-validate`**](https://github.com/dev365code/aas-submodel-validate) | Judges **AAS submodels** against IDTA templates | [![PyPI](https://img.shields.io/pypi/v/aas-submodel-validate?label=PyPI&color=3d8b57)](https://pypi.org/project/aas-submodel-validate/)<br>`template packs: 3 shipped` |
